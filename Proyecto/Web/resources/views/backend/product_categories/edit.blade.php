...
@section("title")
{{trans("web.edit")}} {{strtolower(trans("web.product_category"))}}
@endsection

@section("content")
<div class="container">
	{{Form::open(['route' => ['admin.product_categories.update', $category->id], 'method' => 'PUT'])}}
	...
	<div class="form-group">
		<a href="{{route('admin.product_categories.index')}}" class="btn btn-danger" role="button">
			{{trans("web.cancel")}}
		</a>
	</div>
	{{Form::close()}}
