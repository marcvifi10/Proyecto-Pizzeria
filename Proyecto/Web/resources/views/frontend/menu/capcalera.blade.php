...
<div class="xs-menu-cont color">
	...
	<nav class="xs-menu displaynone">
		<ul>
			...
			<li>
				<a href="{{ route('drinks') }}" id="begudes" onclick="begudes()">
					<i class="fab fa-gulp"></i> 
					{{ trans('web.drinks') }}
				</a>
			</li>
			<li>
				<a href="{{ route('menus') }}" id="menus" onclick="menus()">
					<i class="fas fa-pizza-slice"></i> <i class="fab fa-gulp"></i> 
					{{ trans('web.menus_menu') }}
				</a>
			</li>
			<li>
				<a href="{{ route('desserts') }}" id="postres" onclick="postres()">
	...
	<nav class="menu" style="background-color: #FF8F00">
		<ul>
			<li>
				<a href="{{ route('inici') }}">
					<img src="images/logo.png" width="200px" height="100px">
