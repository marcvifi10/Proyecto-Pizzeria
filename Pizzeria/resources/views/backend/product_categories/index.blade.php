...
<div class="container">
    <div class="row">
        <div class="col-sm-2">
            <a href="{{route('admin.product_categories.create')}}" class="btn btn-primary" role="button">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('admin.product_categories.edit', $category->id)}}" class="btn btn-primary" role="button">
                                {{trans("web.edit")}}
                            </a>
                        </td>
                        <td>
                            {{Form::open(['route' => ['admin.product_categories.destroy', $category->id],
                    ...
                    @empty
                    <tr>
                        <td colspan=5>{{trans("web.categories_not_found")}}</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
